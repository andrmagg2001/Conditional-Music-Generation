...
def main():
    ...
    parser.add_argument("--ckpt", type=str, default="data/checkpoints/conditioned_transformer_v2/best.pth")
    parser.add_argument("--out", type=str, default="data/checkpoints/conditioned_transformer_v2/best.onnx")
